...
var file_response_proto_rawDesc = []byte{
	...
	0x22, 0x2c, 0x0a, 0x18, 0x50, 0x72, 0x65, 0x73, 0x69, 0x67, 0x6e, 0x50, 0x75, 0x74, 0x4f, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03,
	0x55, 0x52, 0x4c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x55, 0x52, 0x4c, 0x42, 0x08,
...
var file_response_proto_goTypes = []interface{}{
	(*PresignPutObjectResponse)(nil), // 0: PresignPutObjectResponse
}
...
func file_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_response_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PresignPutObjectResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
